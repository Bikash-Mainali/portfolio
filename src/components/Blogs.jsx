                ...
                <div className="p-8">
                    ...
                    <div className="markdown-body text-zinc-300 leading-relaxed text-base mb-6">
                        <ReactMarkdown
                            ...
                            components={{
                                h1: ({node, ...props}) => <h1 className="text-2xl font-bold text-white mt-6 mb-3"
                                                              style={{fontFamily: "'Georgia',serif"}} {...props} />,
                                h2: ({node, ...props}) => <h2 className="text-xl font-bold text-white mt-5 mb-2"
                                                              style={{fontFamily: "'Georgia',serif"}} {...props} />,
                                h3: ({node, ...props}) => <h3
                                    className="text-lg font-semibold text-zinc-200 mt-4 mb-2" {...props} />,
                                p: ({node, ...props}) => <p
                                    className="text-zinc-300 mb-4 leading-relaxed" {...props} />,
                                a: ({node, ...props}) => <a
                                    className="text-amber-400 hover:text-amber-300 underline underline-offset-2"
                                    target="_blank" rel="noopener noreferrer" {...props} />,
                                strong: ({node, ...props}) => <strong
                                    className="text-white font-semibold" {...props} />,
                                em: ({node, ...props}) => <em className="text-zinc-300 italic" {...props} />,
                                code: ({node, inline, ...props}) =>
                                    inline
                                        ? <code
                                            className="bg-zinc-800 text-amber-400 px-1.5 py-0.5 rounded text-sm font-mono" {...props} />
                                        : <code
                                            className="block bg-zinc-800/80 text-amber-300 p-4 rounded-xl text-sm font-mono overflow-x-auto mb-4 border border-zinc-700" {...props} />,
                                pre: ({node, ...props}) => <pre className="mb-4" {...props} />,
                                ul: ({node, ...props}) => <ul
                                    className="list-disc list-inside text-zinc-300 mb-4 space-y-1 pl-2" {...props} />,
                                ol: ({node, ...props}) => <ol
                                    className="list-decimal list-inside text-zinc-300 mb-4 space-y-1 pl-2" {...props} />,
                                li: ({node, ...props}) => <li className="text-zinc-300" {...props} />,
                                blockquote: ({node, ...props}) => <blockquote
                                    className="border-l-4 border-amber-500/50 pl-4 italic text-zinc-400 my-4" {...props} />,
                                table: ({node, ...props}) => <div className="overflow-x-auto mb-4">
                                    <table className="w-full text-sm border-collapse" {...props} />
                                </div>,
                                th: ({node, ...props}) => <th
                                    className="text-left text-zinc-300 font-semibold border-b border-zinc-700 px-3 py-2 bg-zinc-800/50" {...props} />,
                                td: ({node, ...props}) => <td
                                    className="text-zinc-400 border-b border-zinc-800 px-3 py-2" {...props} />,
    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-zinc-100" style={{fontFamily: "'Georgia', serif"}}>
            <div className="flex items-center text-black">
                <Link to="/"
                      className="p-1.5  hover:text-white hover:scale-110 delay-150 duration-200  transition rounded bg-amber-500  m-2">
                    Home
                </Link>
            </div>
            {/* Hero */}
            ...
            <div className="max-w-7xl mx-auto px-6 py-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-10">
                    <div className="relative flex-1">
                        <svg className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-500" fill="none"
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-900 border border-gray-500 text-zinc-200 placeholder-zinc-600 rounded-xl pl-10 pr-4 py-2.5 text-sm outline-none focus:border-zinc-600 transition-colors"
                        />
                    </div>
