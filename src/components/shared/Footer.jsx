...
export default function Footer() {
    return (
        <footer id="footer"
                className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 md:pt-32 lg:pt-40 pb-8 flex flex-col md:flex-row items-center md:items-center justify-between gap-6 md:gap-4 text-center md:text-left">
            {/* Brand */}
